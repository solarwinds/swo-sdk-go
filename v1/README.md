...
```bash
go get github.com/solarwinds/swo-sdk-go/v1
```
...
import (
	...
	"github.com/solarwinds/swo-sdk-go/v1"
	"github.com/solarwinds/swo-sdk-go/v1/models/components"
	"github.com/solarwinds/swo-sdk-go/v1/retry"
	"log"
	"models/operations"
	"os"
)
...
import (
	...
	"errors"
	"github.com/solarwinds/swo-sdk-go/v1"
	"github.com/solarwinds/swo-sdk-go/v1/models/apierrors"
	"github.com/solarwinds/swo-sdk-go/v1/models/components"
	"log"
	"os"
)
	...
	res, err := s.Dem.CreateWebsiteMonitor(ctx, components.Website{
		...
		AvailabilityCheckSettings: &components.AvailabilityCheckSettings{
			...
			Ssl: &components.SslMonitoring{
				...
				DaysPriorToExpiration:          v1.Int(7),
				IgnoreIntermediateCertificates: v1.Bool(true),
			},
			...
			AllowInsecureRenegotiation: v1.Bool(true),
			PostData:                   v1.String("{\"example\": \"value\"}"),
		},
		Tags: []components.Tag{
			components.Tag{
				Key:   "environment",
...
func main() {
	...
	s := v1.New(
		v1.WithServerURL("https://api.na-01.cloud.solarwinds.com"),
		v1.WithSecurity(os.Getenv("SWO_API_TOKEN")),
	)
