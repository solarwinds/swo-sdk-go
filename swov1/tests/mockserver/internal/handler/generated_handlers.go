...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		...
		NewGeneratedHandler(ctx, http.MethodDelete, "/v1/dem/uris/{entityId}", pathDeleteV1DemUrisEntityID(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/v1/dem/probes", pathGetV1DemProbes(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/v1/dem/settings", pathGetV1DemSettings(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/v1/dem/uris/{entityId}", pathGetV1DemUrisEntityID(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/dem/uris", pathPostV1DemUris(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPut, "/v1/dem/uris/{entityId}", pathPutV1DemUrisEntityID(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPut, "/v1/dem/uris/{entityId}/pauseMonitoring", pathPutV1DemUrisEntityIDPauseMonitoring(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPut, "/v1/dem/uris/{entityId}/unpauseMonitoring", pathPutV1DemUrisEntityIDUnpauseMonitoring(dir, rt)),
