...
* [ListIntegrations](#listintegrations) - List all integration instances for the organization
* [ListIntegrationsByType](#listintegrationsbytype) - List integration instances by type
* [GetIntegration](#getintegration) - Get an integration instance by ID
* [DeleteIntegration](#deleteintegration) - Delete an integration instance

## ListIntegrations

List all integration instances for the organization

### Example Usage

<!-- UsageSnippet language="go" operationID="listIntegrations" method="get" path="/v1/integrations" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="listIntegrationsByType" method="get" path="/v1/integrations/{type}" -->
```go
package main
...
func main() {
    ...
    res, err := s.Integrations.ListIntegrationsByType(ctx, operations.ListIntegrationsByTypeRequest{
        Type: "<value>",
    })
    if err != nil {
        log.Fatal(err)
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                | [context.Context](https://pkg.go.dev/context#Context)                                                | :heavy_check_mark:                                                                                   | The context to use for the request.                                                                  |
| `request`                                                                                            | [operations.ListIntegrationsByTypeRequest](../../models/operations/listintegrationsbytyperequest.md) | :heavy_check_mark:                                                                                   | The request object to use for the request.                                                           |
| `opts`                                                                                               | [][operations.Option](../../models/operations/option.md)                                             | :heavy_minus_sign:                                                                                   | The options for this request.                                                                        |

### Response

**[*operations.ListIntegrationsByTypeResponse](../../models/operations/listintegrationsbytyperesponse.md), error**
...
<!-- UsageSnippet language="go" operationID="getIntegration" method="get" path="/v1/integrations/{type}/{clientId}/{id}" -->
```go
package main
...
func main() {
    ...
    if res.IntegrationsIntegration != nil {
        // handle response
    }
}
```
...
<!-- UsageSnippet language="go" operationID="deleteIntegration" method="delete" path="/v1/integrations/{type}/{clientId}/{id}" -->
```go
package main
