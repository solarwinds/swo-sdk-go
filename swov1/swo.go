...
// Generated from OpenAPI doc version 1.0.15 and generator version 2.881.4
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.15.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.15.0 2.881.4 1.0.15 github.com/solarwinds/swo-sdk-go/swov1",
