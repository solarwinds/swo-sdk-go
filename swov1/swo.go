...
// Generated from OpenAPI doc version 1.0.10 and generator version 2.721.3
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.10.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.10.1 2.721.3 1.0.10 github.com/solarwinds/swo-sdk-go/swov1",
