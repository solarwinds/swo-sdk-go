...
// Generated from OpenAPI doc version 1.0.9 and generator version 2.687.13
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.9.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.9.0 2.687.13 1.0.9 github.com/solarwinds/swo-sdk-go/swov1",
