...
// Generated from OpenAPI doc version 1.0.16 and generator version 2.893.0
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.15.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.15.3 2.893.0 1.0.16 github.com/solarwinds/swo-sdk-go/swov1",
