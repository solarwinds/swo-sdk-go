...
// Generated from OpenAPI doc version 1.0.14 and generator version 2.879.11
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.13.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.13.3 2.879.11 1.0.14 github.com/solarwinds/swo-sdk-go/swov1",
