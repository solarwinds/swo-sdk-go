...
// Generated from OpenAPI doc version 1.0.11 and generator version 2.727.4
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.11.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.11.0 2.727.4 1.0.11 github.com/solarwinds/swo-sdk-go/swov1",
