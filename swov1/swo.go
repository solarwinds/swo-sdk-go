...
// Generated from OpenAPI doc version 1.0.13 and generator version 2.801.2
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.13.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.13.2 2.801.2 1.0.13 github.com/solarwinds/swo-sdk-go/swov1",
