...
// Generated from OpenAPI doc version 1.0.9 and generator version 2.662.0
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.6.16",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.6.16 2.662.0 1.0.9 github.com/solarwinds/swo-sdk-go/swov1",
