...
// Generated from OpenAPI doc version 1.0.12 and generator version 2.755.9
...
func New(opts ...SDKOption) *Swo {
	sdk := &Swo{
		SDKVersion: "0.12.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.12.1 2.755.9 1.0.12 github.com/solarwinds/swo-sdk-go/swov1",
